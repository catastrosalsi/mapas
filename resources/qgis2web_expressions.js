...
function exp_calles_4rule0_eval_expression(context) {
    // INFR  IN ('ADOQUIN', 'ASFALTO', 'CORDON CUN')

    var feature = context.feature;
    
    if (feature.properties) {
        return "'ADOQUIN', 'ASFALTO', 'CORDON CUN'".indexOf(feature.get('INFR') ) > -1 ;
    } else {
        return "'ADOQUIN', 'ASFALTO', 'CORDON CUN'".indexOf(feature.get('INFR') ) > -1 ;
    }
}
...
function exp_calles_4rule1_eval_expression(context) {
    // INFR = 'TIERRA'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('INFR')  == 'TIERRA');
    } else {
        return (feature.get('INFR')  == 'TIERRA');
    }
}
...
function exp_calles_4rule2_eval_expression(context) {
    // 
